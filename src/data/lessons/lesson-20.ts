...
export const lesson20: LessonData = {
  ...
  welcomeEmoji: "🧩",
  pageTitle: "English Learning - Condicionales en inglés",
  metaDescription: "Domina los condicionales en inglés. Aprende los cuatro tipos principales (cero, primero, segundo y tercero) y las expresiones I wish e If only para hablar de posibilidades, hipótesis y deseos.",
  learningPoints: [
    "La estructura gramatical de cada tipo de condicional",
    "Cuándo se usa cada uno (real, hipotético, pasado, deseo, etc.)",
    "Cómo combinar tiempos verbales correctamente",
    "Las diferencias entre los tipos de condicionales",
    "Cómo usar I wish y If only para expresar emociones o arrepentimientos",
  ...
  quiz: [
    {
      ...
      options: ["will boil", "boils", "would boil", "boil"],
      correctAnswer: 1,
      explanation: "Hecho científico → Zero Conditional. Usamos Present Simple en ambas partes: 'If you heat... it boils'."
    },
    {
      question: "If I see John, I ___ him to call you.",
      options: ["will tell", "would tell", "told", "tell"],
      correctAnswer: 0,
      explanation: "Posible en el futuro → First Conditional. Usamos: If + Present Simple, will + infinitive."
    },
    {
      question: "If I ___ more time, I would learn another language.",
      options: ["have", "had", "had had", "will have"],
      correctAnswer: 1,
      explanation: "Situación hipotética en el presente → Second Conditional. Usamos: If + Past Simple, would + infinitive."
    },
    {
      question: "If they ___ earlier, they would have caught the train.",
      options: ["had left", "left", "would leave", "leave"],
      correctAnswer: 0,
      explanation: "Hipotético en el pasado → Third Conditional. Usamos: If + Past Perfect, would have + past participle."
    },
    {
      question: "I wish I ___ taller.",
      options: ["will be", "were", "had been", "am"],
      correctAnswer: 1,
      explanation: "Deseo sobre el presente → I wish + Past Simple. 'Were' es la forma correcta para situaciones hipotéticas presentes."
    },
    {
      question: "If I were rich, I ___ a big house.",
      options: ["will buy", "would buy", "would have bought", "buy"],
      correctAnswer: 1,
      explanation: "Hipotético en el presente → Second Conditional. Usamos: If + Past Simple, would + infinitive."
    },
    {
    ...
    {
      question: "If only I ___ harder last year, I would have passed.",
      options: ["study", "had studied", "would study", "studied"],
      correctAnswer: 1,
      explanation: "Deseo/arrepentimiento sobre el pasado → If only + Past Perfect. Se refiere a algo que no hicimos en el pasado."
    },
    {
      question: "If people don't drink water, they ___.",
      options: ["would die", "die", "will die", "died"],
      correctAnswer: 1,
      explanation: "Verdad general → Zero Conditional. Usamos Present Simple en ambas partes para hechos universales."
    },
    {
      question: "I wish I ___ the truth.",
      options: ["know", "had known", "knew", "have known"],
      correctAnswer: 1,
      explanation: "Arrepentimiento sobre el pasado → I wish + Past Perfect. 'Had known' indica que no supe algo en el pasado y ahora lo lamento."
    }
  ]
};
